...
export default function AddGeneralTransactionPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const res = await addGeneralTransaction(formData);
    ...
    <div className="max-w-xl mx-auto pb-20 pt-6">
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <div className="p-6 border-b border-gray-200 bg-gray-50">
          <h1 className="text-xl font-bold text-gray-900">Catat Kas Umum</h1>
          <p className="text-sm text-gray-500">
            Transaksi non-proker (Kas rutin, Operasional).
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-xs">Uang Kas/Denda</span>
            </label>
            <label
            ...
            >
              ...
              <span className="text-xs">ATK/Operasional</span>
            </label>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                name="description"
                type="text"
                placeholder="Contoh: Uang Kas Bulan Januari"
